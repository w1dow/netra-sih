...
import { SearchBar, QuickActions, StatCard, CategoryCard, TrustPillarCard } from '../components/HomeComponents';
import { LoadingState, ErrorState, EmptyState } from '../components/StateViews';
import { statistics, procurementCategories, trustPillars } from '../constants';
import { useTenders, useNews } from '../api';
  ...
  return (
    <div className="home">
      ...
      <section className="hero" aria-label="Hero">
        ...
        <div className="hero__content container">
          ...
          <p className="hero__subheading">
            AI-powered bid compliance verification for faster, smarter and more transparent government procurement.
          </p>
      ...
      <section className="section tenders-section" aria-labelledby="tenders-heading">
        <div className="container">
          <div className="section__header">
            ...
            <p className="section__subtitle">Explore current government procurement opportunities</p>
          </div>
          <TenderFilters filters={filters} onChange={setFilters} />

          {tendersLoading ? (
            <LoadingState message="Fetching active tenders from Express JS API..." />
          ) : tendersError ? (
      ...
      {newsData && newsData.length > 0 && (
        <section className="section news-section" style={{ background: 'var(--color-white)', borderTop: '1px solid var(--color-border-light)' }}>
          <div className="container">
            <div className="section__header">
              <h2 className="section__title">Tender & Procurement Updates</h2>
      ...
      <section className="section compliance-section" aria-labelledby="compliance-heading">
        <div className="container">
          <div className="section__header">
            <h2 id="compliance-heading" className="section__title">AI-Powered Bid Compliance Verification</h2>
            <p className="section__subtitle">
              Use AI to extract evidence from bidder documents, map requirements, identify compliance gaps and surface risk for procurement officers.
            </p>
          </div>
          <ComplianceWorkflow />
        </div>
      ...
      <section className="section categories-section">
        <div className="container">
          <div className="section__header">
            <h2 className="section__title">Procurement Categories</h2>
            <p className="section__subtitle">Browse tenders by procurement category</p>
          </div>
          <div className="categories-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: 'var(--space-4)' }}>
      ...
      <section className="trust-section">
        <div className="container">
          <div className="section__header">
            <h2 className="section__title section__title--light">Built for Transparent Public Procurement</h2>
          </div>
          <div className="trust-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 'var(--space-5)' }}>
