  ...
  return (
    <div className="page">
      <div className="page__header">
        <div className="page__header-inner">
          ...
          <p className="page__description">
            Browse, search and filter all current government procurement opportunities fetched live from Express & MySQL backend.
          </p>
        </div>
      </div>
      <div className="page__body">
        ...
        {loading ? (
          <LoadingState message="Loading tenders list from Express backend..." />
        ) : error ? (
